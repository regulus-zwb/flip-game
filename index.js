...
function rem_select(i) {
  ...
  rem_class("tile_icon_" + i, "fa-paw");
  rem_class("tile_icon_" + i, "fa-star");
  rem_class("tile_icon_" + i, "fa-female");
  rem_class("tile_icon_" + i, "fa-male");
  rem_class("tile_icon_" + i, "fa-tint");
  rem_class("tile_icon_" + i, "fa-smile-o");
  rem_class("tile_icon_" + i, "fa-gift");
  rem_class("tile_icon_" + i, "fa-frown-o");
  rem_class("tile_icon_" + i, "child");
}
